	...
	<div class="container">
		...
		<div class="row">
			<div
				...
				<form id="reg-form" role="form" action="<c:url value='/register' />" method="post">
					<h2>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<h4>登陆名</h4>
								<input type="text" name="username" id="first_name" class="form-control input-lg" placeholder="4 ~ 15个字符" tabindex="1" />
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<h4>邮箱</h4>
								<input type="email" name="email" id="email" class="form-control input-lg" placeholder="不会乱发邮件的哦~" tabindex="4" />
							</div>
						</div>
						<%-- <div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<h4>昵称</h4>
								<input type="text" name="nickname" id="last_name" class="form-control input-lg" placeholder="2 ~ 15个字符"	tabindex="2">
							</div>
						</div> --%>
					</div>
					<div class="row">
					...
					<div id="err-msg" style="color:red">${ message }</div>
